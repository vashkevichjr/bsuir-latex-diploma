...
\usepackage[top=20mm, bottom=20mm, left=30mm, right=15mm]{geometry} % СТП 01-2024

\linespread{1.00} % СТП 01-2024
...
\newcommand{\@csectionnostar}[1]{%
    \@csection*{\MakeUppercase{#1}}%
}

\newcommand{\@csectionwithtoc}[1]{%
    \@csection*{\MakeUppercase{#1}}%
    \addcontentsline{toc}{section}{#1}%
}

\newcommand{\csection}{\@ifstar{\@csectionnostar}{\@csectionwithtoc}}
...
{%
    ...
    \@appendix*{\MakeUppercase{\textbf{Приложение \theappendix}} \\ (#1) \\[1em] \textbf{#2}}%
    \markboth{\MakeUppercase{#1}}{}%
    \addcontentsline{toc}{section}{Приложение {\theappendix}}%
}
\makeatother
...
{\begin{itemize}[leftmargin=0cm, labelwidth=\widthof{где}, itemindent=\widthof{где} + 1ex, labelsep=1ex]\renewcommand{\labelitemi}{}}
{\end{itemize}}
...
{%
    ...
    \setlength{\itemindent}{-\bibindent+\parinlen}%
...
\RecustomVerbatimEnvironment{Verbatim}{Verbatim}{fontsize=\fontsize{12pt}{16pt}\selectfont}
